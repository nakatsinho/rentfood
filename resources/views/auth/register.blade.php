            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                        <h2 style="color: orangered;">Atenção: </h2>
                        <span style="color: limegreen;">Infelizmente, só damos cobertura de entregas, para as Zonas ou Bairros listados abaixo!</span>
                        </p>
                        </div>
                            @csrf
                            <div class="form-group row">
