                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="filter__found">
                                <h6><span>{{$promos->count()}}</span> Products found</h6>
                            </div>
                        </div>
                        ...
                        <div class="product__discount__item">
                            <div class="product__discount__item__pic set-bg" data-setbg="{{url('admin/img/product/',$promo->image)}}">
                                ...
                                <ul class="product__item__pic__hover">
                                    ...
                                    <li><a href="{{route('product.show',$promo->id)}}"><i class="fa fa-retweet"></i></a></li>
                                    <li><a href="{{route('cart.show',$promo->id)}}"><i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <div class="product__discount__item__text">
                                <?php $caty = DB::table('categories')->where('id', $promo->category_id)->first() ?>
                                <span>{{$caty->name}}</span>
