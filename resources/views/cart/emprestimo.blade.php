...
<div class="col-lg-6">
    <h1>{{$head}}</h1> <br>
    <p>Caro(a) <b>{{$user}}</b>, confirme os seus dados abaixo! Esta é uma notificação retornando que o seu pedido de emprestimo foi <strong style="color:limegreen">recebido com sucesso</strong>, a {{$order->created_at}}. Prometemos retornar em breve. Estamos a avaliar os dados que nos submeteu.</p>
    <br>
    ===========================================================================================================================================================
    ...
    <ul>
        ...
        <li>Forma de Pagemento: {{$formasP}} </li>
        <li>Data para Pagamento: {{$validade}}</li>
        <br>
        <li>
            <b>Seu Pedido:</b>
            <br>
            <ul>
                <li>
                    <table class="table">
                        ...
                        <tbody>
                            @foreach($cabaz as $value)
                            <tr>
                                <td class="text-center">1</td>
                                <td>{{$value->name}}</td>
                                <td class="text-right">MZN {{$value->price}}</td>
                                <td class="text-right">MZN {{$value->price*1}}</td>
                            </tr>
                            @endforeach
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right">MZN 300.00</td>
                            </tr>
                            <!-- <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><strong>MZN {{$value->price+300}}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </li>
